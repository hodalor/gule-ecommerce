      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">support@gule.com</p>
                  </div>
                </div>
        ...
        <div className="mt-16">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-gray-900">How can I become a seller on Gule?</h3>
                <p className="mt-2 text-gray-600">
                  You can register as a seller by clicking on "Become a Seller" on our homepage. 
                  Fill out the registration form, verify your identity, and start listing your products.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  ...
                  You can also track your orders by logging into your account and visiting the "My Orders" section.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  ...
                  with all tags and packaging. Some restrictions may apply for certain categories.
                </p>
              </div>
            </div>
          </div>
