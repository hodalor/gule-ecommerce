  ...
  const contactInfo = [
    {
      ...
      title: 'Address',
      details: ['123 Marketplace Street', 'Business District', 'City, State 12345']
    },
    {
    ...
    },
    {
      ...
      title: 'Email',
      details: ['support@gule.com', 'business@gule.com']
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Simply sign up for a seller account, complete your profile, and start listing your products. Our team will review your application within 24-48 hours.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Shipping times vary by seller and location. Most orders are processed within 1-2 business days and delivered within 3-7 business days.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                We offer a 30-day return policy for most items. Products must be in original condition. Return shipping costs may apply depending on the reason for return.
              </p>
            </div>
          </div>
        </div>
