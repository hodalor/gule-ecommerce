...
router.get('/',
  ...
  query('role').optional().isIn(['super_admin', 'admin', 'accountant', 'review_officer', 'customer_support', 'marketing_manager']).withMessage('Invalid role'),
...
router.put('/:id',
  ...
  body('role').optional().isIn(['super_admin', 'admin', 'accountant', 'review_officer', 'customer_support', 'marketing_manager']).withMessage('Invalid role'),
